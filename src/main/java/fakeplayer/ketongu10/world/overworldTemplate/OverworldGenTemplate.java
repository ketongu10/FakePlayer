package fakeplayer.ketongu10.world.overworldTemplate;
...
public class OverworldGenTemplate implements IChunkGenerator
{
	protected static final IBlockState STONE = Blocks.BARRIER.getDefaultState();
	protected static final IBlockState GRAVEL = Blocks.BEDROCK.getDefaultState();
	protected static final IBlockState WATER = Blocks.CYAN_GLAZED_TERRACOTTA.getDefaultState();
	protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
	protected static final IBlockState BEDROCK = Blocks.CLAY.getDefaultState();
	...
	public OverworldGenTemplate(World worldIn, long seed) {
