...
public class BiomeProviderEndTemp extends BiomeProvider
{
	private GenLayer genBiomes;
	private GenLayer biomeIndexLayer;
	private BiomeCache biomeCache;

	public BiomeProviderEndTemp() 
	{
		this.biomeCache = new BiomeCache(this);
	}

	public BiomeProviderEndTemp(long seed) 
	{
		this();
		GenLayer[] agenlayer = GenLayerFixEndTemp.createWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public BiomeProviderEndTemp(World world) 
	{
		this(world.getSeed());
	}
