...
public class ConfigHandler 
{
	...
	public static int ENTITY_FAKEPLAYER = 253;
	...
	public static void init(File file)
	{
		...
		ENTITY_FAKEPLAYER = config.getInt("Entity Fake Player", category, 253, 253, 500, "Entity Fake Player ID");
	...
	{
		FakePlayer.config = new File(event.getModConfigurationDirectory() + "/" + Reference.MOD_ID);
		FakePlayer.config.mkdirs();
		init(new File(FakePlayer.config.getPath(), Reference.MOD_ID + ".cfg"));
	}
}
