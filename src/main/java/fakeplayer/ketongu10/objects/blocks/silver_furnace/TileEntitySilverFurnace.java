package fakeplayer.ketongu10.objects.blocks.silver_furnace;

import fakeplayer.ketongu10.objects.blocks.silver_furnace.slots.SlotSilverFurnaceFuel;
...
public class TileEntitySilverFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
	...
	{
		fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntitySilverFurnace.class, new String[] {"Items"}));
	}
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = SilverFurnaceRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = SilverFurnaceRecipes.instance().getCookingResult(itemstack);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) 
    {
    	...
    	{
    		ItemStack itemStack = this.furnaceItemStacks.get(1);
    		return isItemFuel(stack) || SlotSilverFurnaceFuel.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
    	}
    }
    ...
    {
    	return "fakeplayer:silver_furnace";
    }
    
    @Override
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) 
    {
    	return new ContainerSilverFurnace(playerInventory, this);
    }
